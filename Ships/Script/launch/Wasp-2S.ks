...
launchGuidance["RegisterProgram"]("lowerAscent",
                BasicGuidance(scheduler["tNow"],
                              ...
                              SqrtPitchProgram(800,60000,30),
                              AzimuthYawProgram(80,
                                                7730,
                                                True))).
...
scheduler["Schedule"]
    ...
    ("at", 1,10)("LaunchGuidance_Disengage")
         ("and")("exec", SpinUp@)
    ("at", 1,15)("stage")   // separate and ulage s2
    ("at", 1,17)("stage")   // ignite s2
    ("at", 2,12)("stage")   // separate and ullage s3
    ("at", 2,14)("stage")   // ignite s3
    ("at", 2,16)("stage")   // ditch upper interstage
    ("at", 8,00)("done")
    .
